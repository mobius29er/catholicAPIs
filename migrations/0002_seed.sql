...
INSERT INTO apis (slug, name, tagline, description, homepage_url, docs_url, repo_url, kind, track, launched_at, platforms, pricing, pricing_note, open_source, license, auth, cors, official, categories, languages, status, deprecated, deprecated_note, source, source_url)
VALUES ('magisterium-ai-api', 'Magisterium AI API', 'Answers grounded in Church documents, with citations, over an OpenAI-compatible API.', 'A retrieval-augmented answer engine trained on the corpus of Church teaching — councils, encyclicals, the Catechism, canon law — that returns citations with every answer rather than free-associating. The API is OpenAI-compatible, so most existing SDKs and agent frameworks work against it by changing the base URL. Billing is pay-as-you-go on input and output tokens; the console shows usage.', 'https://www.magisterium.com/developers', 'https://www.magisterium.com/developers', NULL, 'api', 'api', NULL, '[]', 'paid', 'Pay-as-you-go per token. See the developer pricing page for current rates.', 0, NULL, 'api-key', 'unknown', 0, '["AI & Search","Church Documents","Catechism & Doctrine"]', '["en","es","fr","it","pt","de","pl"]', 'published', 0, NULL, NULL, NULL)
ON CONFLICT(slug) DO UPDATE SET
  name = excluded.name,
  tagline = excluded.tagline,
  description = excluded.description,
...
INSERT INTO apis (slug, name, tagline, description, homepage_url, docs_url, repo_url, kind, track, launched_at, platforms, pricing, pricing_note, open_source, license, auth, cors, official, categories, languages, status, deprecated, deprecated_note, source, source_url)
VALUES ('geomesse-api', 'geomesse-api', 'Mass times, searchable by location.', 'An open-source API for finding when and where Mass is celebrated near a given place, from the Carpe Deum project. Coverage depends on the underlying dataset, so check your country before designing a feature around it.', 'https://github.com/carpedeum-fr/geomesse-api', NULL, 'https://github.com/carpedeum-fr/geomesse-api', 'api', 'api', NULL, '[]', 'free', NULL, 1, NULL, 'unknown', 'unknown', 0, '["Mass Times"]', '["fr","en"]', 'published', 1, 'Moved to the Attic of Awesome-Catholic (CatholicOS), which considers it dead or superseded. Still carried by the servusdei2018 list, so treat with caution rather than as confirmed dead.', NULL, NULL)
ON CONFLICT(slug) DO UPDATE SET
  name = excluded.name,
  tagline = excluded.tagline,
  description = excluded.description,
...
INSERT INTO apis (slug, name, tagline, description, homepage_url, docs_url, repo_url, kind, track, launched_at, platforms, pricing, pricing_note, open_source, license, auth, cors, official, categories, languages, status, deprecated, deprecated_note, source, source_url)
VALUES ('sanctum-ipsum', 'sanctum-ipsum', 'Lorem ipsum, but from the saints.', 'A placeholder-text generator that fills your mockups with the words of the saints instead of Cicero. Usable from the website or as an API. Not serious infrastructure, and all the better for it.', 'https://github.com/graysonhicks/sanctum-ipsum', NULL, 'https://github.com/graysonhicks/sanctum-ipsum', 'api', 'api', NULL, '[]', 'free', NULL, 1, NULL, 'none', 'unknown', 0, '["Developer Tools","Quotes"]', '["en","la"]', 'published', 0, NULL, NULL, NULL)
ON CONFLICT(slug) DO UPDATE SET
  name = excluded.name,
  tagline = excluded.tagline,
  description = excluded.description,
...
INSERT INTO apis (slug, name, tagline, description, homepage_url, docs_url, repo_url, kind, track, launched_at, platforms, pricing, pricing_note, open_source, license, auth, cors, official, categories, languages, status, deprecated, deprecated_note, source, source_url)
VALUES ('tamil-bible-database', 'Tamil Bible Database', 'Tamil scripture as a database dump with a PHP API.', 'The Tamil Bible in MySQL with a thin PHP API in front of it. Self-hosted rather than a service you call, which is exactly what you want if you are shipping to a region with patchy connectivity.', 'https://github.com/jayarathina/Tamil-Bible-Database', NULL, 'https://github.com/jayarathina/Tamil-Bible-Database', 'dataset', 'api', NULL, '[]', 'free', NULL, 1, NULL, 'none', 'unknown', 0, '["Bible"]', '["ta"]', 'published', 0, NULL, NULL, NULL)
ON CONFLICT(slug) DO UPDATE SET
  name = excluded.name,
  tagline = excluded.tagline,
  description = excluded.description,
...
INSERT INTO apis (slug, name, tagline, description, homepage_url, docs_url, repo_url, kind, track, launched_at, platforms, pricing, pricing_note, open_source, license, auth, cors, official, categories, languages, status, deprecated, deprecated_note, source, source_url)
VALUES ('catechism-ccc-json', 'catechism-ccc-json', 'The Catechism of the Catholic Church as structured JSON.', 'All 2,865 paragraphs of the Catechism in JSON, keyed by paragraph number and preserving the part/section/chapter/article hierarchy. Ready to index for search or to embed for retrieval — the usual first ingredient in a Catholic RAG pipeline.', 'https://github.com/nossbigg/catechism-ccc-json', NULL, 'https://github.com/nossbigg/catechism-ccc-json', 'dataset', 'api', NULL, '[]', 'free', NULL, 1, NULL, 'none', 'unknown', 0, '["Catechism & Doctrine"]', '["en"]', 'published', 1, 'Moved to the Attic of Awesome-Catholic (CatholicOS), which considers it dead or superseded. Still carried by the servusdei2018 list, so treat with caution rather than as confirmed dead.', NULL, NULL)
ON CONFLICT(slug) DO UPDATE SET
  name = excluded.name,
  tagline = excluded.tagline,
  description = excluded.description,
...
INSERT INTO apis (slug, name, tagline, description, homepage_url, docs_url, repo_url, kind, track, launched_at, platforms, pricing, pricing_note, open_source, license, auth, cors, official, categories, languages, status, deprecated, deprecated_note, source, source_url)
VALUES ('aquinas-opera-omnia', 'AquinasOperaOmnia', 'The complete works of St. Thomas Aquinas.', 'The full Aquinas corpus in machine-readable form — the Summa and a great deal besides. A large, clean text corpus for search, citation tooling or embeddings, and one of the few places to get the whole thing without scraping.', 'https://github.com/Geremia/AquinasOperaOmnia', NULL, 'https://github.com/Geremia/AquinasOperaOmnia', 'dataset', 'api', NULL, '[]', 'free', NULL, 1, NULL, 'none', 'unknown', 0, '["Spiritual Reading","Catechism & Doctrine"]', '["la","en"]', 'published', 0, NULL, NULL, NULL)
ON CONFLICT(slug) DO UPDATE SET
  name = excluded.name,
  tagline = excluded.tagline,
  description = excluded.description,
